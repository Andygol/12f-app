...
**[پردازه‌های](./processes.md) برنامه‌ی دوازده-سازه *یکبار مصرف* هستند، به این معنی که می توان آنها را در یک آن، ایجاد یا متوقف کرد.** این کار مقیاس‌پذیری سریع و منعطف، استقرار سریع [کد](./codebase.md) یا [پیکربندی](./config.md) تغییرات و استحکام عملیات را تسهیل می‌کند.

پردازه‌ها می‌بایست **زمان راه اندازی حداقلی داشته باشند**. در حالت ایده‌آل، یک پردازه از زمان اجرای دستور راه‌اندازی، چند ثانیه طول می‌کشد تا آماده‌ی پردازش درخواست‌ها یا کارها شود. زمان راه‌اندازی کوتاه، چابکی بیشتری را برای فرایند [انتشار](./build-release-run.md) و افزایش مقیاس‌پذیری فراهم می‌کند. و به استحکام برنامه کمک می کند، زیرا مدیر سیستم در صورت لزوم می‌تواند به راحتی پردازه‌ها را به ماشین‌های فیزیکی جدید منتقل کند.
